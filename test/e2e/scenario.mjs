...
export const runEndToEndScenario = async (runtime) => {
  console.log(`[e2e:${runtime}] loading tokenizer`)
  ...
  console.log(`[e2e:${runtime}] checking wrapped inference failure`)
  await expectWrappedInferenceError()
  console.log(`[e2e:${runtime}] ok`)
}
