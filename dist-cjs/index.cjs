...
__export(index_exports, {
  LocalInferenceUtilsError: () => LocalInferenceUtilsError,
...
var usesWasmRuntimeOnly = () => isNodeJs() || isDeno()
var getExecutionProviders = () =>
  usesWasmRuntimeOnly() ? ['wasm'] : ['webnn', 'webgpu', 'webgl', 'wasm']
var getInferenceSession = async () => {
  if (usesWasmRuntimeOnly()) {
    const runtime2 = await import('onnxruntime-web')
    if (isDeno()) {
      runtime2.env.wasm.numThreads = 1
    }
    return runtime2.InferenceSession
  }
...
// node_modules/@sovereignbase/bytecodec/dist/.errors/class.js
...
// node_modules/@sovereignbase/bytecodec/dist/toBase64String/index.js
...
// node_modules/@sovereignbase/bytecodec/dist/toUint8Array/index.js
  ...
  return async function (moduleArg = {}) {
    ...
    if (ENVIRONMENT_IS_NODE) {
      ...
      if (!import_meta.url.startsWith('data:')) {
        scriptDirectory =
          nodePath.dirname(require2('url').fileURLToPath(import_meta.url)) + '/'
      }
      readBinary = (filename) => {
    ...
    var UTF8Decoder =
      typeof TextDecoder != 'undefined' ? new TextDecoder() : void 0
...
`
    ...
    Module['dynCall_jiji'] = (a0, a1, a2, a3, a4) =>
      (Module['dynCall_jiji'] = wasmExports['V'])(a0, a1, a2, a3, a4)
    Module['dynCall_viijii'] = (a0, a1, a2, a3, a4, a5, a6) =>
      (Module['dynCall_viijii'] = wasmExports['W'])(a0, a1, a2, a3, a4, a5, a6)
    Module['dynCall_iiiiij'] = (a0, a1, a2, a3, a4, a5, a6) =>
      (Module['dynCall_iiiiij'] = wasmExports['X'])(a0, a1, a2, a3, a4, a5, a6)
    Module['dynCall_iiiiijj'] = (a0, a1, a2, a3, a4, a5, a6, a7, a8) =>
      (Module['dynCall_iiiiijj'] = wasmExports['Y'])(
        a0,
        a1,
        a2,
        a3,
    ...
    Module['dynCall_iiiiiijj'] = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9) =>
      (Module['dynCall_iiiiiijj'] = wasmExports['Z'])(
        a0,
        a1,
        a2,
        a3,
